  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isPresentation && "[&_.lesson-content]:text-present-body",
        isPresentation && "[&_.lesson-content_h1]:text-present-heading",
        isPresentation && "[&_.lesson-content_h2]:text-present-heading",
        isPresentation && "[&_.lesson-content_p]:text-present-body",
