      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-surface rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between p-6 border-b">
            <h2 className="text-lg font-semibold text-text-primary">Create IQA Sample</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none"
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="text-xs px-2 py-1 bg-surface-hover text-text-secondary rounded hover:bg-surface-active transition-colors"
                  >
                    Select All
                  </button>
                  <button
