        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-sm sm:text-base font-medium text-text-primary truncate max-w-[150px] sm:max-w-[300px]">
                {page.title}
              </h1>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 text-text-tertiary hover:text-text-secondary transition-colors p-1.5 rounded hover:bg-surface-hover"
          ...
          <div className="bg-surface rounded-lg shadow-xl p-6 max-w-sm mx-4">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-4 py-2 bg-teal text-white rounded-lg hover:bg-forest transition-colors"
              >
