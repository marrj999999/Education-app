...
export default function AssessmentsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className="min-h-screen bg-surface-hover flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block w-8 h-8 border-4 border-assess border-t-transparent rounded-full animate-spin" role="status" aria-label="Loading assessments" />
  ...
  return (
    <div className="min-h-screen bg-surface-hover">
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-bold text-text-primary">Assessments</h1>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-surface border border-border text-text-secondary text-sm font-medium rounded-lg hover:bg-surface-hover transition-colors"
            >
      ...
      <main id="main-content" className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {criteria.length === 0 ? (
          <div className="bg-surface rounded-xl shadow-sm border border-border p-8 text-center">
            ...
            <p className="text-text-tertiary">No OCN criteria defined for this course yet.</p>
            <p className="text-sm text-text-tertiary mt-1">Criteria are defined in the CMS lesson content.</p>
          </div>
        ) : (
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            <div className="relative bg-surface rounded-xl shadow-xl w-full max-w-md p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-text-primary">Update Assessment</h2>
                <button
              ...
              <div className="space-y-4">
                ...
                <div className="bg-surface-hover rounded-lg p-3">
                  ...
                  <p className="text-xs text-text-tertiary mt-1">{selectedCell.criterion.lessonTitle}</p>
                </div>
                ...
                {/* Evidence Notes */}
                <div>
                  <label className="block text-sm font-medium text-text-secondary mb-1">Evidence Notes</label>
                  <textarea
                    value={modalNotes}
                ...
                <div className="flex justify-end gap-3 pt-2">
                  <button
                    onClick={() => setSelectedCell(null)}
                    className="px-4 py-2 text-sm font-medium text-text-secondary bg-surface-hover rounded-lg hover:bg-surface-active transition-colors"
                  >
                    Cancel
                  </button>
                  <button
